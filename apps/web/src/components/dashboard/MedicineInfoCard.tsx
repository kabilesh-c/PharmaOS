  ...
  return (
    <div className="bg-dark-card rounded-card shadow-card p-6 text-white h-full">
      <div className="flex items-center justify-between mb-4">
        ...
        <span className="group relative flex items-center gap-1 px-2 py-1 bg-primary-yellow/20 text-primary-yellow rounded-full text-xs font-bold cursor-help">
          <Brain size={12} />
          AI-Powered
      ...
      <div className="flex items-center gap-6">
        <div className="w-40 h-40 rounded-full bg-dark-card-light flex items-center justify-center relative">
          ...
          {/* AI Prediction Ring */}
          <div className="absolute inset-0 rounded-full border-2 border-dashed border-primary-yellow/30 animate-pulse" />
        </div>
        <div className="flex flex-col gap-3">
          ...
          <div className="mt-2 pt-2 border-t border-white/10">
            <div className="flex items-center gap-1.5 text-xs text-neutral-400">
              <Sparkles size={10} className="text-primary-yellow" />
