...
export default function RecentOrdersCard() {
  ...
  return (
    <div className="bg-white rounded-card shadow-card p-6 h-full min-h-[500px] flex flex-col">
          ...
          <tbody>
            {orders.map((order) => (
              <tr key={order.id} className="border-b border-neutral-100">
                ...
                <td className="py-3">
                  <span className="px-3 py-1 bg-primary-yellow/20 text-neutral-900 text-xs font-medium rounded-pill">
                    {order.type}
                  </span>
                </td>
                <td className="py-3">
                  <button className="px-4 py-1.5 bg-neutral-100 hover:bg-primary-yellow text-neutral-900 text-sm font-medium rounded-button transition-colors">
                    Sale Now
                  </button>
                </td>
              </tr>
